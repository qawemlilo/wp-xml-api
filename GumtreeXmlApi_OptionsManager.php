...
class GumtreeXmlApi_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'gumtree-xml-api'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'gumtree-xml-api'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'gumtree-xml-api'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'gumtree-xml-api'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'gumtree-xml-api');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'gumtree-xml-api'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'gumtree-xml-api');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'gumtree-xml-api'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'gumtree-xml-api') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'gumtree-xml-api');
            case 'false':
                return __('false', 'gumtree-xml-api');

            case 'Administrator':
                return __('Administrator', 'gumtree-xml-api');
            case 'Editor':
                return __('Editor', 'gumtree-xml-api');
            case 'Author':
                return __('Author', 'gumtree-xml-api');
            case 'Contributor':
                return __('Contributor', 'gumtree-xml-api');
            case 'Subscriber':
                return __('Subscriber', 'gumtree-xml-api');
            case 'Anyone':
                return __('Anyone', 'gumtree-xml-api');
        }
        return $optionValue;
    }
